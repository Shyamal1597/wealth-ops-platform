          ...
          <Card className="mb-8 border-l-4 border-l-primary-500">
            <CardContent className="pt-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="font-semibold text-lg mb-2">About Morning Buzz</h2>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <a
                        ...
                        aria-label={`Download ${update.title} report for ${formatDate(update.reportDate)} (${(update.fileSize / 1024 / 1024).toFixed(2)} MB) (opens in a new tab)`}
                      >
