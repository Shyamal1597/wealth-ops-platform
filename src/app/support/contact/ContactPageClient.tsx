...
export default function ContactPage() {
  const [formData, setFormData] = useState({
    ...
    subject: "",
    message: "",
    queryType: "other" as "franchise_ap" | "other",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setFormData({ name: "", email: "", phone: "", subject: "", message: "", queryType: "other" });
      } else {
                ...
                <CardContent>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <label htmlFor="contact-query-type" className="block text-sm font-medium mb-2">Query Type *</label>
                        <select
                          id="contact-query-type"
                          required
                          value={formData.queryType}
                          onChange={(e) => setFormData({ ...formData, queryType: e.target.value as "franchise_ap" | "other" })}
                          className="w-full border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white"
                        >
                          <option value="other">Other Queries</option>
                          <option value="franchise_ap">Franchise / AP Queries</option>
                        </select>
                      </div>
                    </div>
                    <div>
