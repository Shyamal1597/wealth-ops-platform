            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Sunidhi Charity Foundation</strong> actively supports institutions and organisations that stand for causes that are close to our hearts. The sectors we are present in are education, healthcare (homes for the physically and mentally challenged) and animal care centres. The Foundation is part of Sunidhi's social responsibility agenda.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Sunidhi offers support to a <strong>50-bed ward at K J Somaiya Hospital and Research Center in Mumbai</strong>. This is a leaf out of our book of giving.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
