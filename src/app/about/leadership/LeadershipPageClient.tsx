        ...
        <section className="py-16 bg-gray-50">
          <Container>
            ...
            <div className="relative max-w-5xl mx-auto">
              ...
              {/* Caption */}
              <div className="mt-6 text-center px-4" aria-live="polite" aria-atomic="true">
              ...
              <button
                onClick={prevSlide}
                className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-900 rounded-full p-3 shadow-lg transition-all hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
              ...
              <button
                onClick={nextSlide}
                className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-900 rounded-full p-3 shadow-lg transition-all hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
              ...
              <div className="flex justify-center gap-2 mt-8">
                {timeline.map((_, index) => (
                  <button
                    ...
                    className={`transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 ${index === currentIndex
                      ? 'w-8 h-3 bg-primary-600 rounded-full'
                      : 'w-3 h-3 bg-gray-500 rounded-full hover:bg-gray-600'
                      }`}
