...
import { Building2, TrendingUp, Shield, CheckCircle2, Award, Briefcase, Phone, Mail, ArrowRight } from "lucide-react";
        ...
        <Container>
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-center text-gray-600 mt-8">
              Looking to raise or escalate a complaint?{" "}
              <a
                href="/support/contact?scrollTo=escalation-matrix"
                className="text-primary-600 hover:text-primary-700 font-semibold inline-flex items-center gap-1"
              >
                View our Escalation Matrix
