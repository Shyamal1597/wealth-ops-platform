...
function SearchResults() {
  ...
  const searchablePages = [
    // Expertise
    { title: 'Retail Equity & Equity Trading', href: '/expertise/retail-equity', description: 'Pioneers of online market trading in India — equity, commodity, internet, and currency trading, plus trading platforms and market access.', keywords: 'equity trading stocks shares market buy sell demat nse bse online broker platform', category: 'Expertise' },
    ...
    { title: 'Derivatives & Commodity Trading', href: '/expertise/commodities-trading', description: 'Futures & Options trading plus a robust commodity dealing desk covering gold, silver, crude oil, and currency derivatives.', keywords: 'commodity gold silver crude oil mcx ncdex derivatives futures options fno currency', category: 'Expertise' },
    ...
    { title: 'Mutual Funds & Wealth Management', href: '/expertise/mutual-fund-distribution', description: 'Explore our range of mutual fund products — SIP, lump sum, tax-saving ELSS — plus portfolio management and wealth advisory services.', keywords: 'mutual fund sip systematic investment plan elss tax saving nav amc scheme lump sum wealth management portfolio advisor', category: 'Expertise' },
