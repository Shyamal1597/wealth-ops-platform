        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Stock Market Trading - Open Trading Account
            </h1>
            <p className="text-xl text-primary-100 mb-8">
              Experience seamless stock market trading and intraday trading across NSE and BSE. Open trading account with best trading app in India for capital market investments with advanced platforms, real-time market data, and expert research support.
            </p>
