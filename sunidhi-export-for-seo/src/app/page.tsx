  ...
  const services = [
    {
      ...
      description: "Trade seamlessly across NSE and BSE with our advanced trading platform",
      icon: TrendingUp,
      link: "/services/equity-trading",
    },
    {
      title: "Derivatives & F&O",
      description: "Access futures and options trading with comprehensive market analysis",
      icon: BarChart3,
      link: "/services/derivatives",
    },
    {
      title: "Mutual Funds",
      description: "Invest in 3,646+ schemes from 52+ leading AMCs with zero commission",
      icon: PieChart,
      link: "/services/mutual-funds",
    },
    {
      title: "Depository Services",
      description: "Secure and efficient demat account services for all your securities",
      icon: Shield,
      link: "/expertise/depository-services",
    },
    {
      title: "IPO Investments",
      description: "Get access to latest IPOs and public offerings with expert guidance",
      icon: Briefcase,
      link: "/services/ipo",
    },
    {
        ...
        <Container className="relative z-10">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
              Navigate the markets with confidence. Expert guidance, advanced technology, and trusted partnerships for over {yearsOfExcellence} years.
            </p>
        ...
        <Container>
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              From equity trading to wealth management, we offer a complete suite of financial solutions
            </p>
          </div>
      ...
      <section className="py-12 bg-gradient-to-br from-gray-50 to-gray-100">
        <Container>
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Experience the power of professional trading in your pocket with our advanced mobile application
            </p>
          </div>
            ...
            <Card className="bg-gradient-to-br from-primary-50 to-white border-2 border-primary-200 shadow-xl">
              <CardContent className="p-8 md:p-12">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-6">
                  ...
                  <div className="hidden md:flex gap-2 flex-shrink-0">
                    <button
                      ...
                      className="w-10 h-10 rounded-full bg-white border-2 border-primary-600 text-primary-600 flex items-center justify-center hover:bg-primary-600 hover:text-white transition-colors shadow-md"
                    >
                ...
                <div className="flex md:hidden justify-center gap-3 mt-6">
                  <button
                    onClick={prevTestimonial}
                    className="w-12 h-12 rounded-full bg-white border-2 border-primary-600 text-primary-600 flex items-center justify-center hover:bg-primary-600 hover:text-white transition-colors shadow-md"
                  >
        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-white/90 mb-6">
              Join thousands of satisfied investors who trust Sunidhi Securities for their financial growth
            </p>
