          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-8 text-center text-sm text-gray-600">
              ...
              <p className="mt-2">
                ...
                <a href="mailto:Rahul.bisht@sunidhi.com" className="text-primary-600 hover:underline">
                  Rahul.bisht@sunidhi.com
                </a>
                {" "}or{" "}
                <a href="mailto:Shyamal.gajjar@sunidhi.com" className="text-primary-600 hover:underline">
                  Shyamal.gajjar@sunidhi.com
                </a>
              </p>
            </div>
          </div>
