                  ...
                  <table className="w-full">
                    <thead className="bg-green-600 text-white">
                      <tr>
                        ...
                        <th className="px-6 py-4 text-left font-bold">Occasion</th>
                        {selectedSegment === "all" && (
                          <th className="px-6 py-4 text-left font-bold">Segments</th>
                        )}
                      </tr>
                    </thead>
                      ...
                      {workingDayHolidays.length > 0 ? (
                        workingDayHolidays.map((holiday, index) => (
                          <tr key={index} className={index % 2 === 0 ? "bg-green-50" : "bg-white"}>
                            ...
                            <td className="px-6 py-4 text-gray-900 font-medium">{holiday.date}</td>
                            <td className="px-6 py-4">
                              <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                {holiday.day}
                              </span>
                            </td>
                            <td className="px-6 py-4 text-gray-700">{holiday.occasion}</td>
                            {selectedSegment === "all" && (
                              <td className="px-6 py-4">
                                <div className="flex flex-wrap gap-1">
                                  {holiday.segments.map(seg => (
                                    <span key={seg} className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-700">
                                      {getSegmentLabel(seg)}
                                    </span>
                                  ))}
                                </div>
                        ...
                        <tr>
                          <td colSpan={selectedSegment === "all" ? 5 : 4} className="px-6 py-8 text-center text-gray-500">
